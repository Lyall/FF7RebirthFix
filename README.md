...
Active development has moved to [Codeberg](https://codeberg.org/Lyall/FF7RebirthFix).  
...
This is an ASI plugin for Final Fantasy VII Rebirth that adds ultrawide/narrower support and more.
